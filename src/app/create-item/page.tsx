    ...
    <div className="min-h-screen bg-[url('/uploads/doggybkg.png')] bg-repeat bg-red-700 flex items-center justify-center px-4 py-10">
      ...
      >
        ...
        <div className="space-y-5">
          ...
          {tags.map((tag, idx) => (
          <span key={idx} className="bg-white text-black px-3 py-1 rounded-full text-sm flex items-center gap-1">
        {tag}
        <button type="button"onClick={() => setTags(tags.filter((_, i) => i !== idx))} className="text-red-600 font-bold hover:text-red-800">×</button>
      </span>
    ))}
    ...
    />
        ...
        {/*The input for the location.*/}
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <img src="/uploads/pin.png" alt="Location Icon" className="w-6 h-6" />
        ...
        <div className="space-y-4 flex flex-col justify-start pt-[60px]">
          ...
          <div className="w-full h-78 bg-white/10 border-2 border-white rounded-md flex items-center justify-center overflow-hidden">
            ...
            {preview ? (
              ...
              <img src="/uploads/uploads-placeholder.png" alt="Upload icon" className="h-60 opacity-60" />
            )}
          </div>
          {/*The upload button.*/}
